...
​				做网站静态化，推荐使用路径参数，打包后的文件，会自动根据参数进行文件拆分
...
​			1.开发完，运行yarn build 把打包生成好的目录一起放到服务器指定的位置

![image-20230705102043819](README.assets/image-20230705102043819.png)

​			2.yarn 安装需要的包

​			3.在服务端项目根目录 yarn start
